...
public class ShadowOctopusController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (player != null)
        {
            ...
            FlipOctopus(direction);
        }
    }

    // Flip the octopus based on direction
    void FlipOctopus(Vector3 direction)
    {
        if (direction.x > 0)
        {
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            GameManager.instance.AddScore(30);      // Add score when an enemy is destroyed
