...
public class InkLauncher : MonoBehaviour
{
    [Header("Config")]
    ...
    [Header("Audio")]
    [SerializeField] AudioSource splatInkAudioSource;
    [Range(-2, 2)]
    [SerializeField] float pitchRange = .2f;

    [Header("Timing")]
    [SerializeField] public float fireRate = 1.0f; // Time between shots in seconds
    ...
    public void Launch()
    {
        ...
        splatInkAudioSource.pitch = Random.Range(1f-pitchRange,1f+pitchRange);
        splatInkAudioSource.Play();
